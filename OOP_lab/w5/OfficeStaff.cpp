...
OfficeStaff::OfficeStaff(string fullNamme, string ID, int startedYear, int month, int baseSalary, int workday, int subsidy) : Staff(fullNamme, ID, startedYear, month)
{
